...
class ArtikelController extends Controller
{
    ...
    public function store(ArtikelRequest $request)
    {
        ...
        $artikel->save();
        $artikel->kategoris()->attach($request->input('kategori_id'));
        $artikel->tags()->attach($request->input('tag_id'));
    ...
    public function edit($id)
    {
        ...
        $kategori = Kategori::all();
        $tag = Tag::all();
        return view('artikel.edit', compact('artikel', 'kategori', 'tag'));
    }
    ...
    public function update(ArtikelRequest $request, $id)
    {
        ...
        $artikel->save();
        $artikel->kategoris()->detach($artikel->kategoris);
        $artikel->tags()->detach($artikel->tags);
        $artikel->kategoris()->attach($request->input('kategori_id'));
        $artikel->tags()->attach($request->input('tag_id'));
