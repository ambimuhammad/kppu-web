    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <a href="{{ route('service.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
                    Tambah Service</a>
                @endcan
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-bordered table-striped" id="table-service">
                            <thead>
                                <tr>
                                    <th width="5%">No</th>
                                    <th>Image</th>
...
<script src="{{ asset('js/Service/datatable-service.min.js') }}"></script>
@endpush