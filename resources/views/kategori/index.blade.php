    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                @can('create kategori')
                <a href="{{ route('kategori.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
                    Tambah Kategori</a>
                @endcan
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-bordered table-striped" id="table-kategori">
                            <thead>
                                <tr>
                                    <th width="5%">No</th>
                                    <th>Nama Kategori</th>
...
<script src="{{ asset('js/Kategori/datatable-kategori.min.js') }}"></script>
@endpush
