			...
			<div class="tp-banner" >
				<ul>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="" data-delay="13000"  data-saveperformance="off"  data-title="Our Workplace">
						<img src="{{ asset('front/trend/images/slider/1.jpg') }}"  alt="kenburns1"  data-bgposition="left center" data-kenburns="on" data-duration="14000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="130" data-bgpositionend="right center">
					...
					<li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
						<!-- MAIN IMAGE -->
						<img src="{{ asset('front/trend/images/dummy.png') }}"  alt="2" data-lazyload="{{ asset('front/trend/images/slider/2.jpg') }}" data-bgposition="right top" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
						<!-- LAYERS -->
						<!-- LAYER NR. 1 -->
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/1.jpg') }}"><i class="icon-plus2"></i></a>
				...
				<div class="project-item illustration web-design illustration">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/2.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item illustration print">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/3.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item photography web-design">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/4.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item branding">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/5.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item illustration web-design print">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/6.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item photography branding illustration">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/7.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item illustration web-design">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/8.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item branding web-design print">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/9.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
				...
				<div class="project-item photography branding">
					<div class="project-gal">
						...
						<div class="overlay-folio">
							<div class="hover-box">
								<div class="hover-zoom">
									<a class="mp-lightbox zoom" href="{{ asset('front/trend/images/projects/10.jpg') }}"><i class="icon-plus2"></i></a>
									<a class="link" href="portfolio-single-slider.html"><i class="icon-link3"></i></a>					
								</div>
							</div>
						</div>
