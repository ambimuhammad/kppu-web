		...
		<div class="container">
			<div class="navbar yamm navbar-default">
				<div class="navbar-header">
					...
					<a href="index.html" class="navbar-brand"><img src="{{ asset('front/trend/images/basic/logo.png') }}" width="40" alt=""/></a>
				</div>
				...
				<div class="header-x pull-right">
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<br>
							<div class="ci-item">
								<img src="{{ asset('front/trend/images/shop/2.jpg') }}" width="70" alt=""/>
							...
							<div class="ci-item">
								<img src="{{ asset('front/trend/images/shop/8.jpg') }}" width="70" alt=""/>
								<div class="ci-item-info">
									<h5><a href="./single-product.html">Product fashion</a></h5>
									<p>2 x $250.00</p>
									<div class="ci-edit">
